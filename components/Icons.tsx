...
export const Dumbbell: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M14.4 14.4 9.6 9.6"/><path d="M18.657 21.485a2 2 0 1 1-2.829-2.828l-1.767 1.768a2 2 0 1 1-2.829-2.828l-1.768 1.768a2 2 0 1 1-2.828-2.828l1.768-1.768a2 2 0 1 1 2.828-2.828l1.768-1.768a2 2 0 1 1 2.829 2.828l1.767-1.768a2 2 0 1 1 2.829 2.829z"/><path d="m21.5 21.5-1.4-1.4"/><path d="m3.9 3.9 1.4 1.4"/><path d="M2.464 21.485a2 2 0 1 0 2.829-2.828l1.768 1.768a2 2 0 1 0 2.828-2.828l1.768 1.768a2 2 0 1 0 2.829-2.828l-1.768-1.768a2 2 0 1 0-2.828-2.828l-1.768-1.768a2 2 0 1 0-2.828 2.828l-1.768 1.768a2 2 0 1 0-2.829 2.829z"/></svg>
);
...
export const Scale: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m16 16-4-4-4 4"/><path d="M12 22a10 10 0 1 1 0-20 10 10 0 0 1 0 20Z"/><path d="M12 12V2"/></svg>
);
...
export const Brain: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M9.879 7.121A3 3 0 1 0 12 5h0a3 3 0 0 0 2.121 5.121"/><path d="M12 12a3 3 0 1 0 4.243 4.243M12 12a3 3 0 1 1-4.243 4.243"/><path d="M12 12V7.5"/><path d="M15.536 15.536A5 5 0 1 0 12 10a5 5 0 0 0 3.536 8.536"/><path d="M8.464 15.536A5 5 0 1 1 12 10a5 5 0 0 1-3.536 8.536"/></svg>
);
...
export const ArrowUpCircle: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="12" cy="12" r="10"/><path d="m8 12 4-4 4 4"/><path d="M12 16V8"/></svg>
);
